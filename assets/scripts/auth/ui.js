...
const signInSuccess = function (signInResponse) {
  ...
  // $('.alert-success').toggleClass('hide').fadeOut(2000)
  clearForms()
...
const signOutSuccess = function () {
  ...
  // $('#create-new-item-btn').toggleClass('hide')
  $('.navbar-default').toggleClass('hide')
  $('.alert-success').html('<strong>Success!</strong> You have been signed out successfully!').toggleClass('hide').fadeOut(2000)
  console.log('store is ', store)
